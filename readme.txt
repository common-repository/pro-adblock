=== Pro-AdBlock ===
Contributors: sergej_k
Tags: adblock, security, web surfing, modal, advertising
Requires at least: 4.5
Tested up to: 4.9.6
Stable tag: 2.0.0

This plugin shows a warning message to users that have no adblocker enabled.
...
1. Download the and extract the archive, then copy the extracted folder to your WordPress plugins directory, either by uploading it via FTP or by using the "Add Plugin" function of WordPress.
...
= v1.2.2 =
* Missing translation call added
